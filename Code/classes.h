...
enum parameters {TAO_CONST,K_CONST,LAMBDA_CONST,V_CONST,PSI_CONST, DELTA_CONST,ETA_CONST};
...
class mesh{
    ...
    public:
    //TAO_CONST,K_CONST,LAMBDA_CONST,V_CONST,PSI_CONST, DELTA_CONST,ETA_CONST
        void setParameters(float tao,float k, float lambda, float v, float psi, float delta, float eta){
            parameters[TAO_CONST]=tao;
            parameters[K_CONST]=k;
            parameters[LAMBDA_CONST]=lambda;
            parameters[V_CONST]=v;
